    ...
    extend: {
      ...
      colors: {
        ...
        category: {
          ...
          fitness: "hsl(var(--cat-fitness))",
          learning: "hsl(var(--cat-learning))",
          mindfulness: "hsl(var(--cat-mindfulness))",
          productivity: "hsl(var(--cat-productivity))",
      ...
      boxShadow: {
        ...
        'glow-sm': '0 0 15px rgba(var(--primary), 0.3)',
        'glow-md': '0 0 25px rgba(var(--primary), 0.4)',
